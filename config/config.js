...
var jobLogger = new (winston.Logger)(module.exports.jobLogger);
...
module.exports.jobInfo = function () {
    jobLogger.info(arguments);
};

module.exports.jobError = function () {
...
var initGlobalConfigFolders = function (config, assets) {
    ...
    // Setting globbed server paths
    config.folders.client = getGlobbedPaths(path.join(process.cwd(), 'modules/*/server/'), process.cwd().replace(new RegExp(/\\/g), '/'));
};
